...
{
    public abstract class seafoodWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static seafoodWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(seafoodWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<seafoodDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<seafoodDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<seafoodDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<seafoodDbContext, Task<T>> func)
        {
            T result;
